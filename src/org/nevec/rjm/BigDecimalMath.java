...
public class BigDecimalMath {
	 ...
	 * \protect\vrule
	 * width0pt\protect\href{http://www.cs.arizona.edu/icon/oddsends
	 * /e.htm}{http://www.cs.arizona.edu/icon/oddsends/e.htm} The precision of
	 * the predefined constant is one less than the string's length, taking into
	 ...
	 * width0pt\protect\href{http://www.cs.arizona
	 * .edu/icon/oddsends/pi.htm}{http://www.cs.arizona.edu/icon/oddsends/pi.htm}
	 */
	...
	/**
	 * Euler-Mascheroni constant lower-case gamma. \protect\vrule
	 * width0pt\protect
	 * \href{http://www.worldwideschool.org/library/books/sci/math
	 * /MiscellaneousMathematicalConstants/chap35.html}{http:/
	 */
	 ...
	 * width0pt\protect\href{http://www.worldwideschool
	 * .org/library/books/sci/math
	 * /MiscellaneousMathematicalConstants/chap58.html}{http:/
	 */
	 ...
	 *         implied by x.
	 */
	static public BigDecimal sqrt(final BigDecimal x, MathContext mc) {
		// wrap
		return sqrt (x.setScale(mc.getPrecision(), mc.getRoundingMode()));
	}
	
	// real
	static private BigDecimal sqrt(final BigDecimal x) {
...
//		System.err.println (x);
		return exp (x.setScale(mc.getPrecision(), mc.getRoundingMode()));
	}
	...
	static private BigDecimal exp(final MathContext mc) {
		/* look it up if possible */
	...
	static public BigDecimal log(int n, final MathContext mc) {
		...
		if (n <= 0)
			...
			if (mc.getPrecision() < LOG2.precision())
				...
				/*
				 * Broadhurst \protect\vrule
				 * width0pt\protect\href{http://arxiv.org
				 * /abs/math/9803067}{arXiv:math/9803067} Error propagation: the
	...
	static public BigDecimal pow(final BigDecimal x, final BigDecimal y, MathContext mc) {
		// wrap
		return pow (x.setScale(mc.getPrecision(), mc.getRoundingMode()), y.setScale(mc.getPrecision(), mc.getRoundingMode()));
	}
	
	// real function
	static private BigDecimal pow(final BigDecimal x, final BigDecimal y) {
		if (x.compareTo(BigDecimal.ZERO) < 0)
	 ...
	 * @return Gamma(x).
	 */
	static public BigDecimal Gamma(final BigDecimal x, MathContext mc) {
		// wrap
		return Gamma(x.setScale(mc.getPrecision(), mc.getRoundingMode()));
	}

	// real
	static private BigDecimal Gamma(final BigDecimal x) {
		/*
	...
	static public BigDecimal zeta(final int n, final MathContext mc) {
		...
		if (n % 2 == 0) {
			 ...
			 * width0pt\protect\href{http://arxiv.org
			 * /abs/math/9803067}{arXiv:math/9803067} Error propagation: S31 is
			 * roughly 0.087, S33 roughly 0.131
			 */
			 ...
			 * Broadhurst BBP \protect\vrule
			 * width0pt\protect\href{http://arxiv.org
			 * /abs/math/9803067}{arXiv:math/9803067} Error propagation: S51 is
			 * roughly -11.15, S53 roughly 22.165, S55 is roughly 0.031
